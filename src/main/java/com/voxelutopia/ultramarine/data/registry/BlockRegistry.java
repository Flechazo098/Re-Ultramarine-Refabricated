...
public class BlockRegistry {
    ...
    public static final Block LONG_GILDED_DARK_OAK_QUETI = registerBlock("long_gilded_dark_oak_queti", new WallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 4, 13, 16, 16, 15))));
    public static final Block LONG_GILDED_DARK_OAK_QUETI_EDGE = registerBlock("long_gilded_dark_oak_queti_edge", new OrientableWallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.sideOrientedShape(new RawVoxelShape(0, -4, 12, 32, 16, 16))));
    ...
    public static final Block WOODEN_QUETI = registerBlock("wooden_queti", new WallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 11, 14, 16, 16, 15))));
    public static final Block WOODEN_QUETI_EDGE = registerBlock("wooden_queti_edge", new OrientableWallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 0, 14, 16, 16, 15))));
    ...
    public static final Block SHORT_GLAZED_QUETI = registerBlock("short_glazed_queti", new OrientableWallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.sideOrientedShape(new RawVoxelShape(0, 0, 14, 32, 16, 15))));
    public static final Block THICK_CARVED_QUETI = registerBlock("thick_carved_queti", new SideAxialBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(6, 0, -7, 10, 16, 32))));
    public static final Block SHORT_THICK_GLAZED_QUETI = registerBlock("short_thick_glazed_queti", new SideAxialBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(4, 0, -16, 12, 16, 16))));
    public static final Block WOODEN_GUALUO = registerBlock("wooden_gualuo", new WallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 0, 13, 16, 16, 15))));
    public static final Block LARGE_WOODEN_GUALUO = registerBlock("large_wooden_gualuo", new WallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 0, 13, 16, 16, 15))));
    public static final Block LARGE_WOODEN_GUALUO_EDGE = registerBlock("large_wooden_gualuo_edge", new OrientableWallSideBlock(BaseBlockProperty.WOOD, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 0, 13, 16, 16, 15))));
    ...
    public static final Block CARVED_STONE_QUETI_PART = registerBlock("carved_stone_queti_part", new SideAxialBlock(BaseBlockProperty.STONE, ShapeFunction.cardinalRotations(new RawVoxelShape(4, 0, -9, 12, 16, 31))));
    public static final Block CARVED_STONE_BEAM = registerBlock("carved_stone_beam", new SideAxialBlock(BaseBlockProperty.STONE, ShapeFunction.cardinalRotations(new RawVoxelShape(3.5, 0, -16, 12.5, 16, 32))));
    public static final Block CARVED_STONE_QUETI = registerBlock("carved_stone_queti", new SideAxialBlock(BaseBlockProperty.STONE, ShapeFunction.cardinalRotations(new RawVoxelShape(4, -16, 0, 12, 16, 16))));

    // PATTERNS

    public static final Block YELLOW_CARVED_PATTERN = registerBlock("yellow_carved_pattern", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-6, 2, 15, 22, 14, 16))));
    ...
    public static final Block FLAME_ARCH_WALL_PATTERN = registerBlock("flame_arch_wall_pattern", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-4, 0, 15, 20, 16, 16))));
    public static final Block GOLDEN_DRAGON_FANGXIN_PATTERN = registerBlock("golden_dragon_fangxin_pattern", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-16, 0, 15, 32, 16, 16))));
    ...
    public static final Block LIGHT_BLUE_SU_STYLE_CAIHUA = registerBlock("light_blue_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-9, 0, 15, 23, 16, 16))));
    public static final Block YELLOW_SU_STYLE_CAIHUA = registerBlock("yellow_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-9, 0, 15, 23, 16, 16))));
    public static final Block LIGHT_YELLOW_SU_STYLE_CAIHUA = registerBlock("light_yellow_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-9, 0, 15, 23, 16, 16))));
    public static final Block MEDIUM_SU_STYLE_CAIHUA = registerBlock("medium_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-16, 8, 15, 32, 32, 16))));
    public static final Block LARGE_WHITE_SU_STYLE_CAIHUA = registerBlock("large_white_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-16, 0, 15, 32, 32, 16))));
    public static final Block LARGE_GREEN_SU_STYLE_CAIHUA = registerBlock("large_green_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-16, 0, 15, 32, 32, 16))));
    public static final Block LARGE_GRAY_SU_STYLE_CAIHUA = registerBlock("large_gray_su_style_caihua", new WallSideBlock(BaseBlockProperty.DYE, ShapeFunction.cardinalRotations(new RawVoxelShape(-16, 0, 15, 32, 32, 16))));
    ...
    public static final Block GOLDEN_GLAZED_ROOF_CHARM_ACCESSORY = registerBlock("golden_glazed_roof_charm_accessory", new WallSideBlock(BaseBlockProperty.GLAZED, ShapeFunction.cardinalRotations(new RawVoxelShape(6, 6, 10, 10, 10, 16))));
    ...
    public static final Block SACK = registerBlock("sack",
            ContainerDecorativeBlock.with(BaseBlockProperty.SILK).content(ContainerType.COMMON_SMALL).shaped(ShapeFunction.centeredSquare(6, 6)).directional().noCollision().pushReaction(PushReaction.BLOCK).build());
    public static final Block BAMBOO_TEA_BASKET = registerBlock("bamboo_tea_basket",
            ContainerDecorativeBlock.with(BaseBlockProperty.BAMBOO_WOOD).content(ContainerType.FOOD_REGULAR).shaped(ShapeFunction.eightRotations(new RawVoxelShape(1, 0, 2, 15, 24, 16))).directional().diagonallyPlaceable().noOcclusion().pushReaction(PushReaction.BLOCK).build());
    ...
    public static final Block TERRACOTTA_POT = registerBlock("terracotta_pot",
            DecorativeBlock.with(BaseBlockProperty.TERRACOTTA).shaped(ShapeFunction.diagonalSquare(12, 8)).directional().diagonallyPlaceable().noOcclusion().build());
    ...
    public static final Block GUNNY_SACK = registerBlock("gunny_sack",
            ContainerDecorativeBlock.with(BaseBlockProperty.FLAX).content(ContainerType.COMMON_REGULAR).shaped(ShapeFunction.cardinalRotations(new RawVoxelShape(3, 0, 2, 15, 13, 14))).directional().pushReaction(PushReaction.BLOCK).build());
    ...
    public static final Block FOOD_HAMPER = registerBlock("food_hamper",
            ContainerDecorativeBlock.with(BaseBlockProperty.WOOD).content(ContainerType.FOOD_LARGE).shaped(ShapeFunction.diagonalSquare(7, 15)).directional().diagonallyPlaceable().pushReaction(PushReaction.BLOCK).build());
...
//                    })
    ...
    public static final Block LARGE_ICICLE = registerBlock("large_icicle", new Icicle(2, ShapeFunction.cardinalRotations(new RawVoxelShape(0, 0, 15, 16, 32, 16))));

    // CELEBRATION

    public static final Block COUPLET = registerBlock("couplet", new OrientableWallSideBlock(BaseBlockProperty.PAPER, ShapeFunction.sideOrientedShape(new RawVoxelShape(2, 0, 15, 8, 32, 16))));
    public static final Block COUPLET_TOP = registerBlock("couplet_top", new WallSideBlock(BaseBlockProperty.PAPER, ShapeFunction.cardinalRotations(new RawVoxelShape(6, 2, 15, 26, 8, 16))));
    public static final Block FU_MARK = registerBlock("fu_mark", new WallSideBlock(BaseBlockProperty.PAPER, ShapeFunction.cardinalRotations(new RawVoxelShape(9, 7, 15, 23, 21, 16))));
    ...
    public static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(Ultramarine.MOD_ID, name), new BlockItem(block, new Item.Properties())
        );
    }

    public static void registerModBlocks() {
        Ultramarine.LOGGER.info("Registering Mod Blocks for " + Ultramarine.MOD_ID);
    }
}