...
public class ModBlockEntities {
    ...
    public static void registerModBlockEntities() {
        CONTAINER_DECORATIVE_BLOCK = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Ultramarine.MOD_ID, "container_decorative_block_entity"),
        ...
        CENSER = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Ultramarine.MOD_ID, "censer_block_entity"),
                FabricBlockEntityTypeBuilder.create(CenserBlockEntity::new, new HashSet<>(CENSERS).toArray(new Block[0])).build(null));

        BOTTLE_GOURD = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Ultramarine.MOD_ID, "bottle_gourd_entity"),
